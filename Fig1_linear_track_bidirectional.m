...
function [output] = Fig1_linear_track_bidirectional(cell_id);
...
% heading_vec = behav.headDirection';
% heading_vec = heading_vec(IAbehav,:);
...
inclusion_vector = running_ts; % Only running timestamps
...
bin_vector = 0:bin_size:behav.trackLength+bin_size;
...
output = [M upper_CI95 lower_CI95];
