function [KLD, MI, posterior, occupancy_vector, prob_being_active, likelihood ] = extract_1D_information(binarized_trace, interp_behav_vec, bin_vector, inclusion_vector)
...
occupancyProbChance = 1/length(PDF);
