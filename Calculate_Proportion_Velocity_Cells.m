...
function [Proportion] = calculate_proportion_velocity_cells;
...
for session = 1:nsessions;
 ...
 for cell_i = 1:NCells;
 if extended_calcium_analysis_output(cell_i).SignMI_velocity == 1
 NPlaceCells = NPlaceCells + 1; 
  ...
  ProportionPlaceCells(session,:) = Proportion.PercentagePlaceCells;
   ...
   save('ProportionVelocity.mat', 'Proportion');
  ...
  save('ProportionsVelocity.mat', 'ProportionsSummary');
