...
function [Proportion] = calculate_proportion_HD_cells;
...
for session = 1:nsessions;
 ...
 for cell_i = 1:NCells;
 if extended_calcium_analysis_output(cell_i).SignMI_HD == 1
 NPlaceCells = NPlaceCells + 1; 
  ...
  ProportionPlaceCells(session,:) = Proportion.PercentagePlaceCells;
   ...
   save('ProportionHD.mat', 'Proportion');
  ...
  save('ProportionsHD.mat', 'ProportionsSummary');
